...
export default function InvoiceManagement() {
  ...
  const updateInvoiceMutation = useMutation({
    mutationFn: async (invoiceData: { id: number; amount: string; dueDate: string; status: string }) => {
      const response = await apiRequest("PATCH", `/api/admin/invoices/${invoiceData.id}`, invoiceData);
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Los datos de la factura y su snapshot han sido actualizados.",
      });
    ...
    <DashboardLayout title="Gestión de Facturas">
      <div className="space-y-6">
              ...
              <form onSubmit={handleCreateInvoice} className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    id="description"
                    name="description"
                    placeholder="Ej: Mantenimiento Mensual, Consultoría, etc."
                  />
                </div>
        ...
        <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Editar Factura {editingInvoice?.invoiceNumber}</DialogTitle>
            </DialogHeader>
            <form 
              onSubmit={(e) => {
                e.preventDefault();
